...
import 'package:tiktok_tutorial/views/screens/auth/comment_screen.dart';
import 'package:tiktok_tutorial/views/screens/auth/video_player_item.dart';
      ...
      Container(
        ...
        decoration: BoxDecoration(
          gradient: const LinearGradient(
            ...
            child: ClipRRect(borderRadius: BorderRadius.circular(25),child: Image(image: NetworkImage(profilePhoto),
            fit: BoxFit.cover,
            ),),
                          ...
                          Expanded(
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    data.username,style: const TextStyle(
                                      fontSize: 20,
                                      color: Colors.white,
                                    ...
                                    Text(
                                    data.caption,style: const TextStyle(
                                      fontSize: 15,
                                      color: Colors.white,
                                      ),
                                    ),
                                    Row(
                                      ...
                                      Text(
                                    data.songName,style: const TextStyle(
                                      fontSize: 15,
                                      color: Colors.white,
                                      ),
                                    ),
                                  ...
                                  Column(
                                    children: [
                                      InkWell(
                                        onTap:() {},
                                        child: Icon(
                                          Icons.reply,size: 40,color: Colors.white,
                                          ),
                                          ),
                                          const SizedBox(height: 7,),
